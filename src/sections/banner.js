...
const BANNER_DATA = {
  ...
  text: 'Recommend amazing products to your network and earn money when they buy from your store',
  subcontent : 'Sign up for early access and get 6 months of influencer plan for free !',
  clients: [
    {
      image: client1,
      link: '#',
